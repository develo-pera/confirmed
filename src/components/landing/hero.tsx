...
const Hero = () => {
  return (
    <div className="max-w-6xl w-full mx-auto px-4 pt-50 pb-0">
      <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-center mb-5 text-balance max-w-5xl mx-auto">Host events smarter. Fill rooms, not spreadsheets.</h1>
