  ...
  return (
    <div className={cn("flex flex-col items-center gap-3", className)}>
      ...
      <div className="text-center space-y-0.5">
        <p className="text-xs font-medium">{currentFile ? 'Upload photo' : 'Change photo'}</p>
        <p className="text-[11px] text-muted-foreground">PNG, JPG up to {formatBytes(maxSize)}</p>
      </div>
      {/* Error Messages */}
      {errors.length > 0 && (
